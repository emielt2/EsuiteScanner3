...
public class JavaBrowserGroovyshellDaoES3 {
    ...
    String[] doGebSpockActionOnShell(String bystring, String selectorString, String actionstring, String contentNameString, String shellChooseMid) {
        ...
        try {
            System.out.println(shellReturnString01 + "CHECK02");
            String scriptBegin = new String();
            String scriptMid = new String();
            String scriptEnd = new String();

            scriptBegin = new String("package ES3;import org.openqa.selenium.WebDriver;import ES3.JavaBrowserGroovyshellDaoES3;import org.openqa.selenium.By;public class Test{public static void main(String...args){");
...
//            actionstring = "size()";
            ...
            System.out.println(shellReturnString01 + "CHECK03");
            if (shellChooseMid.equals("JAVACODE")) {
//                scriptMid = new String("System.out.println(\"Good calc: \"+(5/1));JavaBrowserGroovyshellDaoES3 gb = new JavaBrowserGroovyshellDaoES3(); gb.shellReturnString01 = \"DitIsTekstVanuitJAVACODE\";");
                //scriptMid = new String("System.out.println(\"TOMx2\");System.out.println(\"Good calc: \"+(5/1));");
            ...
            System.out.println(shellReturnString01 + "CHECK04");
